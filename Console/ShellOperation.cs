...
{
    public static async Task RunConsoleApp(IServiceProvider services)
    {
    ...
    private static async Task CheckAccountBalance(IAccountService service)
    {
    ...
    private static async Task CreateAccount(IAccountService service)
    {
    ...
    private static async Task DepositMoney(IAccountService service)
    {
        Console.Write("Enter account number: ");
        var accountNumber = Console.ReadLine() ?? "";
    ...
    private static async Task TransferMoney(IAccountService service)
    {
    ...
    private static async Task WithdrawMoney(IAccountService service)
    {
        Console.Write("Enter account number: ");
        var accountNumber = Console.ReadLine() ?? "";
